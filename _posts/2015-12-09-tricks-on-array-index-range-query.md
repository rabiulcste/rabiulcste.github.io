...
author: itsrabiul
excerpt: 'ধরা যাক, আমাদের কাছে ara\[5\] সাইজের একটা এরে আছে । আগেই বলে রাখছি, এরে ইনডেক্স শুরু হবে 1 থেকে, 0 থেকে না। আমাদের এই এরেতে ৭ বার কুয়েরি করতে হবে \[x, y\] ইন্টার্ভালে । প্রতি কুয়েরিতে ওই ইন্টার্ভালের ইনডেক্সগুলোতে 2 যোগ করতে হবে । কুয়েরি শেষে পরিবর্তিত array প্রিন্ট করতে হবে । ara\[5\] = {2, 3, 7, 4, 10}; // array input // 07 queries 1 5 2 4 5 5 2 5'
type: post
id: 264
category:
    - computation
...
publicize_google_plus_url:
    - 'https://plus.google.com/104535553025489658915/posts/JL6Rg49GuiJ'
...
এই ধরনের সমস্যা সাধারনত সেগমেন্ট ট্রি(লেজি প্রপাগেশন) কিংবা বাইনারি ইনডেক্স ট্রি দিয়ে সলভ করা যায়, যার কমপ্লেক্সিটি O(logn) । আমি যেই ট্রিক্সটা নিয়ে লিখছি সেটির কমপ্লেক্সিটি অবশ্য O(n). তবে 2×10^5 সাইজের ইনপুটের ক্ষেত্রে এটা ভালোভাবে কাজে দিবে আর ইমপ্লিমেন্ট করাও সোজা ।
